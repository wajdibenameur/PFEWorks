...
@Entity
@Table(
        name = "observium_interface",
        uniqueConstraints = {
                @UniqueConstraint(name = "uk_observium_interface_host_ifindex", columnNames = {"hostId", "ifIndex"})
        }
)
@Getter
@Setter
public class ObserviumInterface extends BaseEntity {
